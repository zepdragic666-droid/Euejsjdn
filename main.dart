...
import 'package:myapp/quantum_protection_screen.dart';
import 'package:myapp/services/behavioral_anomaly_service.dart';
import 'package:myapp/services/behavioral_obfuscation_service.dart';
import 'package:myapp/services/multimodal_ai_defense_service.dart';
import 'package:myapp/services/process_cloaking_service.dart';
import 'package:myapp/services/rasp_service.dart';
import 'package:myapp/services/secure_api_gateway_service.dart';
import 'package:myapp/services/secure_http_client.dart';
import 'package:myapp/services/secure_storage_service.dart';
import 'package:myapp/services/session_service.dart';
import 'package:myapp/services/signature_verification_service.dart';
import 'package:myapp/services/tamper_proof_logger.dart';
    ...
    final ThemeData darkTheme = ThemeData(
      ...
      cardTheme: CardTheme(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: primarySeedColor.withOpacity(0.3)),
        ),
      ),
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith<Color?>((Set<WidgetState> states) {
            if (states.contains(WidgetState.selected)) {
                return sentientPurple.withOpacity(0.5);
            }
